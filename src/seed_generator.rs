...
pub fn generate_seed_with_address_for_worlds(worlds: &HashMap<String, usize>) -> AddressWithSeed {
    iter::repeat_with(generate_seed_with_address)
        .find(|seed_with_address| check_address(worlds, &seed_with_address.address))
        .unwrap()
}

pub fn check_address(worlds: &HashMap<String, usize>, address: &str) -> bool {
